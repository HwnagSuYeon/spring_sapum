...
<body>
	<div class="list_all">
		...
		<div class="board_view_all">
			<h3 class="post_title">Write a Reply</h3>
			<div class="view_all">
				<form id="reply_frm" class="board_modify_frm" action="${path}/board/answer" method="POST">
					<div class="view_board">
						<div class="view_title mody_ti">
							<input type="hidden" value="${one.bno}" name="bno">
							<input type="text" name="title" class="modi_title" value="${one.title}" readonly="readonly">
						</div>
						
						<div class="comment_area board_content_area ">
							<textarea name="content" id="summernote">${one.content}</textarea>
						...
						<div class="list_btn">
							...
							<button id="reply_add_btn" class="board_btn">ADD</button>
						</div>
					</div>
				</form>
			</div>
