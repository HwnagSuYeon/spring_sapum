...
<body>
	<div class="list_all">
		...
		<div class="board_view_all">
			<c:choose>
				<c:when test="${modi_info.bno == 0}">
					<h3 class="post_title">New post</h3>
				</c:when>
				<c:otherwise>
			...
			<div class="view_all">
				<form id="update_frm" class="board_modify_frm" action="${path}/board/<c:out value="${modi_info.bno == 0 ? 'create' : 'update' }"/>" method="POST">
